  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="overflow-hidden flex-1 p-6 mb-20 md:mb-0">
          <Header />
          ...
          {loading ? (
            ...
            <div
              className="flex-1 p-6 max-h-[425px] overflow-auto mb-20 md:mb-0"
              ref={messagecontainerRef}
            >
              {messages && messages.length > 0 ? (
                messages.map((e, i) => (
                  <div key={i} overflow-auto>
                    <div className="mb-4 p-4 bg-gray-700 text-white gap-1">
                      <div className="p-2 rounded-full text-white text-2xl h-10">
                        <CgProfile />
                      </div>
                      {e.question}
                    </div>
                    ...
                    <div className="mb-4 p-4 bg-gray-700 text-white gap-1">
                      <div className="p-2 rounded-full text-white text-2xl w-25">
                        <FaRobot />
                      </div>

...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-2xl font-semibold mb-6">YourOwnChatBot</div>
      <div className="mb-4">
        <button
          onClick={createChat}
      ...
      <div>
        ...
        <div className="max-h-[350px] overflow-y-auto mb-20 md:mb-0">
          {chats && chats.length > 0 ? (
            chats.map((e) => (
              ...
              >
                ...
                <button
                  className="bg-grey-600 text-white text-xl px-3 py-2 rounded-md hover:bg-red-700"
